...
ITT.OS.lenalidonmide <- readRDS("ITT.OS.lenalidonmide.Rda")
ITT.OS.Placebo <- readRDS("ITT.OS.Placebo.Rda")

ITT.PFS.lenalidonmide <- readRDS("ITT.PFS.lenalidomide.Rda")
ITT.PFS.Placebo <- readRDS("ITT.PFS.Placebo.Rda")

## Note, you do not need to repeat the lenalidomide arm here. You use the same lenalidomide.
...
transition.12.itt.lena <- readRDS("transition.12.itt.lena.Rda")
...
transition.13.itt.lena <- readRDS("transition.13.itt.lena.Rda")
...
transition.23.itt.lena <- readRDS("transition.23.itt.lena.Rda")
...
#############################################################################
# 4.Plot PFS Kaplan-Meier curves of lenalidomide vs. each placebo separately
#############################################################################

surv.summary.km.pfs.itt <- surv_summary(km.pfs.itt,data = deff.data)

surv.summary.km.pfs.itt.Len <- surv.summary.km.pfs.itt[surv.summary.km.pfs.itt$trtc == "Lenalidomide",]
surv.summary.km.pfs.itt.Plac <- surv.summary.km.pfs.itt[surv.summary.km.pfs.itt$trtc == "Placebo",]

#PFS KM curve for Lenalidomide and Placebo-unadjusted(ITT)
PFS.itt <- ggsurvplot(km.pfs.itt,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data = surv.summary.km.pfs.itt.Len  , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  geom_line(data = ITT.PFS.lenalidonmide, aes(x = Time, y = PFS,colour = "Lenalidomide-MSM",linetype = "Lenalidomide-MSM"),size = 0.75) +
  ...
  scale_colour_manual(name="Curve Type",values= c( "Lenalidomide-KM" = BresMed.blue , "Placebo-unadjusted-KM" = BresMed.red ,"Lenalidomide-MSM"= BresMed.blue, "Placebo-unadjusted-MSM" = BresMed.red))+
  scale_linetype_manual(name="Curve Type",values = c( "Lenalidomide-KM" = 1,  "Placebo-unadjusted-KM" = 1, "Lenalidomide-MSM" = 3, "Placebo-unadjusted-MSM" = 3 )) +
  guides(colour = guide_legend(nrow = 2))

PFS.itt.at.risk <- ggsurvplot(km.pfs.itt, combine = TRUE, legend.title = "Treatment",censor=FALSE,xlim = c(0, 180),
                              palette=c(BresMed.blue,BresMed.red),xlab = "Time (months)",break.time.by = 12,risk.table = TRUE,tables.y.text = FALSE)

# PFS KM curve for Lenalidomide and Placebo-adjusted RPSFTM recensoring

surv.summary.km.pfs.rpsft <- surv_summary(km.pfs.rpsft,data = PFS.data)

surv.summary.km.pfs.rpsft.Len <- surv.summary.km.pfs.rpsft[surv.summary.km.pfs.rpsft$trtc == "Lenalidomide",]
...
PFS.rpsft <- ggsurvplot(km.pfs.rpsft,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data = surv.summary.km.pfs.rpsft.Len , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  scale_colour_manual(name="Curve Type",values= c( "Lenalidomide-KM" = BresMed.blue , "Placebo-RPSFT-KM" = BresMed.red ,"Lenalidomide-MSM"= BresMed.blue, "Placebo-RPSFT-MSM" = BresMed.red))+
  scale_linetype_manual(name="Curve Type",values = c( "Lenalidomide-KM" =1,  "Placebo-RPSFT-KM"=1, "Lenalidomide-MSM"=3, "Placebo-RPSFT-MSM"=3 ))+
  guides(colour = guide_legend(nrow = 2))

PFS.rpsft.at.risk <- ggsurvplot(km.pfs.rpsft, combine = TRUE, legend.title = "Treatment",censor=FALSE,xlim = c(0, 180),
                                palette=c(BresMed.blue,BresMed.red),xlab = "Time (months)",break.time.by = 12,risk.table = TRUE,tables.y.text = FALSE)

# PFS KM curve for Lenalidomide and Placebo-censoring at XO

surv.summary.km.censoring.at.crossover <- surv_summary(km.pfs.censoring.at.crossover,data = PFS.data)

surv.summary.km.censoring.at.crossover.Len  <- surv.summary.km.censoring.at.crossover[surv.summary.km.censoring.at.crossover$trtc == "Lenalidomide",]
...
PFS.crossover <- ggsurvplot(km.pfs.censoring.at.crossover,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data = surv.summary.km.censoring.at.crossover.Len   , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  scale_colour_manual(name="Curve Type",values= c( "Lenalidomide-KM" = BresMed.blue , "Placebo-Censoring-KM" = BresMed.red ,"Lenalidomide-MSM"= BresMed.blue, "Placebo-Censoring-MSM" = BresMed.red))+
  scale_linetype_manual(name="Curve Type",values = c( "Lenalidomide-KM" =1,  "Placebo-Censoring-KM"=1, "Lenalidomide-MSM"=3, "Placebo-Censoring-MSM"=3 )) +
  guides(colour = guide_legend(nrow = 2))
...
##############################################################################
# 5.Plot OS Kaplan-Meier curves of lenalidomide vs. each placebo separately.
##############################################################################

# OS KM curve for Lenalidomide and Placebo-unadjusted
surv.summary.km.os.itt <- surv_summary(km.os.itt,data = deff.data)

surv.summary.km.os.itt.Len <- surv.summary.km.os.itt[surv.summary.km.os.itt$trtc == "Lenalidomide",]
...
OS.itt <- ggsurvplot(km.os.itt,break.time.by = 24, colour=NA, censor = FALSE, xlim = c(0, 300), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data = surv.summary.km.os.itt.Len  , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  geom_line(data = ITT.OS.lenalidonmide, aes(x = Time, y = OS,colour = "Lenalidomide-MSM",linetype = "Lenalidomide-MSM"),size = 0.75) +
...
OS.itt.at.risk <- ggsurvplot(km.os.itt, combine = TRUE, legend.title = "Treatment",censor=FALSE,xlim = c(0, 300),
                             palette =c(BresMed.blue,BresMed.red) ,xlab = "Time (months)", break.time.by = 24, risk.table = TRUE,tables.y.text = FALSE)

# OS KM curve for Lenalidomide and Placebo-adjusted RPSFTM recensoring

surv.summary.km.os.rpsft <- surv_summary(km.os.rpsft,data = OS.data)

surv.summary.km.os.rpsft.Len <- surv.summary.km.os.rpsft[surv.summary.km.os.rpsft$trtc == "Lenalidomide",]
...
OS.rpsft <- ggsurvplot(km.os.rpsft,break.time.by = 24, colour=NA, censor = FALSE, xlim = c(0, 300), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.os.rpsft.Len , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  scale_colour_manual(name= "Curve Type",values = c( "Lenalidomide-KM" = BresMed.blue , "Placebo-RPSFTM-KM" = BresMed.red ,"Lenalidomide-MSM"= BresMed.blue, "Placebo-RPSFTM-MSM" = BresMed.red))+
  scale_linetype_manual(name= "Curve Type",values = c( "Lenalidomide-KM" = 1,  "Lenalidomide-MSM"= 3, "Placebo-RPSFTM-KM"=1, "Placebo-RPSFTM-MSM"=3 ))+
  guides(colour = guide_legend(nrow = 2))

OS.rpsft.at.risk <- ggsurvplot(km.os.rpsft, combine = TRUE, legend.title = "Treatment",censor=FALSE,xlim = c(0, 300),
                               palette =c(BresMed.blue,BresMed.red) ,xlab = "Time (months)", break.time.by = 24, risk.table = TRUE,tables.y.text = FALSE)

# OS KM curve for Lenalidomide and Placebo-censoring at XO

surv.summary.km.OS.censoring.at.crossover <- surv_summary(km.OS.censoring.at.crossover,data = OS.data)

surv.summary.km.OS.censoring.at.crossover.Len <- surv.summary.km.OS.censoring.at.crossover[surv.summary.km.OS.censoring.at.crossover$trtc == "Lenalidomide",]
...
OS.censoring.at.crossover <- ggsurvplot(km.OS.censoring.at.crossover,break.time.by = 24, colour=NA, censor = FALSE, xlim = c(0, 300), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.OS.censoring.at.crossover.Len , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  scale_colour_manual(name= "Curve Type",values = c( "Lenalidomide-KM" = BresMed.blue , "Placebo-Censoring-KM" = BresMed.red ,"Lenalidomide-MSM"= BresMed.blue, "Placebo-Censoring-MSM" = BresMed.red))+
  scale_linetype_manual(name= "Curve Type",values = c( "Lenalidomide-KM" = 1,  "Lenalidomide-MSM"= 3, "Placebo-Censoring-KM"=1, "Placebo-Censoring-MSM"=3 ))+
  guides(colour = guide_legend(nrow = 2))
...
#############################################################################
# 6.Plot TTP Kaplan-Meier curves of lenalidomide vs. each placebo separately
#############################################################################
...
surv.summary.km.ttp.itt.Len <- surv.summary.km.ttp.itt[surv.summary.km.ttp.itt$trtc == "Lenalidomide", ]
...
ttp.itt <- ggsurvplot(km.ttp.itt,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data = surv.summary.km.ttp.itt.Len   , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  geom_line(data = transition.12.itt.lena , aes(x = Time, y = P12,colour = "Lenalidomide-MSM",linetype = "Lenalidomide-MSM"),size = 0.75) +
...
surv.summary.km.ttp.rpsft.Len <- surv.summary.km.ttp.rpsft[surv.summary.km.ttp.rpsft$trtc == "Lenalidomide",]
surv.summary.km.ttp.rpsft.Plac <- surv.summary.km.ttp.rpsft[surv.summary.km.ttp.rpsft$trtc == "Placebo",]

# ttp KM curve for Lenalidomide and Placebo-adjusted RPSFTM recensoring
ttp.rpsft <- ggsurvplot(km.ttp.rpsft,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data = surv.summary.km.ttp.rpsft.Len   , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
...
# ttp KM curve for Lenalidomide and Placebo censored at cross.

surv.summary.km.ttp.censoring.at.crossover <- surv_summary(km.ttp.censoring.at.crossover,data = deff.data)

surv.summary.km.ttp.censoring.at.crossover.Len <- surv.summary.km.ttp.censoring.at.crossover[surv.summary.km.ttp.censoring.at.crossover$trtc == "Lenalidomide",]
...
#ttp KM curve for Lenalidomide and Placebo-censoring at XO
...
ttp.censoring.at.crossover <- ggsurvplot(km.ttp.censoring.at.crossover,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.ttp.censoring.at.crossover.Len , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
...
#############################################################################
# 6.Plot TTD Kaplan-Meier curves of lenalidomide vs. each placebo separately
#############################################################################

# TTD KM curve for Lenalidomide and Placebo-unadjusted(ITT)

surv.summary.km.ttd.itt <- surv_summary(km.ttd.itt,data = deff.data)

surv.summary.km.ttd.itt.Len <- surv.summary.km.ttd.itt[surv.summary.km.ttd.itt$trtc == "Lenalidomide", ]
...
ttd.itt <- ggsurvplot(km.ttd.itt,break.time.by = 12, colour= NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.ttd.itt.Len  , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  geom_line(data = transition.13.itt.lena , aes(x = Time, y = P13,colour = "Lenalidomide-MSM",linetype = "Lenalidomide-MSM"),size = 0.75) +
...
# TTD KM curve for Lenalidomide and Placebo-adjusted RPSFTM Re-censoring.

surv.summary.km.ttd.rpsft <- surv_summary(km.ttd.rpsft,data = deff.data)

surv.summary.km.ttd.rpsft.Len <- surv.summary.km.ttd.rpsft[surv.summary.km.ttd.rpsft$trtc == "Lenalidomide",]
...
ttd.rpsft <- ggsurvplot(km.ttd.rpsft,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data = surv.summary.km.ttd.rpsft.Len   , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
...
# TTD KM curve for Lenalidomide and Placebo-censoring at XO

# ttp KM curve for Lenalidomide and Placebo censored at cross.

surv.summary.km.ttd.censoring.at.crossover <- surv_summary(km.ttd.censoring.at.crossover,data = deff.data)

surv.summary.km.ttd.censoring.at.crossover.Len <- surv.summary.km.ttd.censoring.at.crossover[surv.summary.km.ttd.censoring.at.crossover$trtc == "Lenalidomide",]
...
ttd.censoring.at.crossover <- ggsurvplot(km.ttd.censoring.at.crossover,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.ttd.censoring.at.crossover.Len , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
...
#############################################################################
# 6.Plot PPS Kaplan-Meier curves of lenalidomide vs. each placebo separately
#############################################################################

# PPS KM curve for Lenalidomide and Placebo-unadjusted (ITT)

surv.summary.km.pps.itt <- surv_summary(km.pps.itt,data = deff.data)

surv.summary.km.pps.itt.Len <- surv.summary.km.pps.itt[surv.summary.km.pps.itt$trtc == "Lenalidomide", ]
...
pps.itt <- ggsurvplot(km.pps.itt,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.pps.itt.Len  , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
  ...
  geom_line(data = transition.23.itt.lena , aes(x = Time, y = P23,colour = "Lenalidomide-MSM",linetype = "Lenalidomide-MSM"),size = 0.75) +
...
# PPS KM curve for Lenalidomide and Placebo-censored at crossover. 

surv.summary.km.pps.cen_at_cross <- surv_summary(km.pps.cen_at_cross,data = PFS_OS.data)

surv.summary.km.pps.cen_at_cross.Len <- surv.summary.km.pps.cen_at_cross[surv.summary.km.pps.cen_at_cross$trtc == "Lenalidomide", ]
...
pps.cen_at_cross <- ggsurvplot(km.pps.cen_at_cross,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.pps.cen_at_cross.Len  , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
...
# PPS KM curve for Lenalidomide and Placebo - RPSFT. 

surv.summary.km.pps.rpsft <- surv_summary(km.pps.rpsft,data = PFS_OS.data)

surv.summary.km.pps.rpsft.Len <- surv.summary.km.pps.rpsft[surv.summary.km.pps.rpsft$trtc == "Lenalidomide", ]
...
pps.rpsft <- ggsurvplot(km.pps.rpsft,break.time.by = 12, colour=NA, censor = FALSE, xlim = c(0, 180), xlab= "Time (months)", legend.title = '', conf.int = FALSE) +
  geom_step(data =  surv.summary.km.pps.rpsft.Len  , mapping = aes(x = time, y = surv,colour = "Lenalidomide-KM",linetype= "Lenalidomide-KM"), size = 0.75) +
